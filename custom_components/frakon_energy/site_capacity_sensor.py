...
class FrakonSiteCapacitySensor(SensorEntity):
    ...
    def __init__(
        ...
        self._attr_device_info = {
            ...
            "name": "FRAKON Energy – Kapacita přívodu",
            "manufacturer": "FRAKON Energy",
            "model": "Site grid capacity model",
        }
    ...
    def native_value(self) -> float | str | None:
        status = self._status()
        if self._definition.status_sensor:
    ...
    def extra_state_attributes(self) -> Mapping[str, Any]:
        ...
        return {
            ...
            "source_fresh": status.source_fresh,
            "source_age_seconds": status.source_age_seconds,
            "max_source_age_seconds": status.max_source_age_seconds,
            "max_grid_import_kw": status.max_grid_import_kw,
            "current_grid_import_kw": status.current_grid_import_kw,
            "grid_headroom_kw": status.grid_headroom_kw,
            "grid_over_limit_kw": status.grid_over_limit_kw,
