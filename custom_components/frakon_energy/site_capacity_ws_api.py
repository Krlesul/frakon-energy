    ...
    async def websocket_set(
        ...
        try:
            ...
            if CONF_EXECUTION_GUARD_ENABLED in msg:
                ...
                # Older clients updating an existing installation preserve its
                # migrated protection state instead of silently changing safety.
                guard_enabled = current.execution_guard_enabled
            else:
                # A newly entered diagnostic limit is not enforcement until the
