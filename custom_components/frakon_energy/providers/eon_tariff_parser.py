...
# E.ON's detailed commercial table has five price columns. Several distribution
# tariffs share one commercial price column; the mapping is explicit so an
# unsupported/unknown tariff can never fall back to a neighbouring column.
...
def parse_eon_commercial_price_text(
    ...
    *,
    ...
    for index in range(5):
        ...
        if vt_value is None:  # defensive; VT never allows missing pairs
