...
def test_enabled_guard_blocks_insufficient_headroom() -> None:
    decision = evaluate_site_capacity_execution_gate(capacity=_capacity(guard=True, headroom=7.0), planned_power_kw=11.0)
...
def test_enabled_guard_allows_sufficient_headroom() -> None:
    decision = evaluate_site_capacity_execution_gate(capacity=_capacity(guard=True, headroom=7.0), planned_power_kw=6.0)
